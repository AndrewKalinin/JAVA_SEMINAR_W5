...
public class task2 {
    ...
    public static void main(String[] args) {
        String[] emploees = new String[] {"Ivan Ivanov", "Ivan Petrov", "Sergey Kozlov", "Eugeny Petrov", "Sergey Vasilev", "Ivan Smirnov", "Andrey Petrov"};
        ...
        nameRepeat(mapName);
        System.out.println("Names sorted in descending order of popularity: ");
        sortName(mapName);
    }
